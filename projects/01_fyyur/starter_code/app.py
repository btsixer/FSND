...
def venues():
    ...
    return render_template('pages/venues.html', areas=locales)
...
def show_venue(venue_id):
    ...
    # # Corresponding to that venue you will get all the upcoming shows
    ...
    # past_shows = list(map(past_shows))
    # upcoming_shows = list(map(upcoming_shows))
